...
func InitLogger(conf *Config) {
	...
	logger = &MuduLogger{Logger: zapLogger.Sugar(), dynamicLevel: config.ZapConfig.Level}
}

// SetLogger sets logger for gost and getty
...
// SetLoggerLevel use for set logger level
func (dl *MuduLogger) SetLoggerLevel(level string) {
	l := new(zapcore.Level)
